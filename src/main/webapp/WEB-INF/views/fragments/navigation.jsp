...
<nav class="flex px-4 py-2 items-center w-full bg-white border-b border-grey-700 fixed top-0">
    ...
    <a class="hover:text-blue-500 text-lg px-4 py-2" href="${pageContext.request.contextPath}/rankings?
    username=${connected.username}&category=answers&page=0">Rankings</a>
