...
import ch.heigvd.amt.stack.application.answer.command.UnselectAnswerCommand;
...
@WebServlet(name = "UnselectAnswerCommandEndpoint", urlPatterns = "/unselectAnswer.do")
public class UnselectAnswerCommandEndpoint extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            answerFacade.unselect(UnselectAnswerCommand.builder()
